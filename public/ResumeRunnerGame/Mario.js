...
function BoxBounce(num) {
  if (boxInfo[4][num] == -1) {
    ...
    switch (num) {
      case 0:
        boxInfo[4][0] = loadImage("ResumeRunnerGame/pngs/gmail.png");
        if (iconJumpInterval == -1) {
          iconJump(num);
        }
        break;
      case 3:
        boxInfo[4][3] = loadImage("ResumeRunnerGame/pngs/github.png");
        if (iconJumpInterval == -1) {
          iconJump(num);
        }
        break
      case 5:
        boxInfo[4][5] = loadImage("ResumeRunnerGame/pngs/linkden.png");
        if (iconJumpInterval == -1) {
          iconJump(num);
        }
        break;
      case 7:
        boxInfo[4][7] = loadImage("ResumeRunnerGame/pngs/phone.png");
        if (iconJumpInterval == -1) {
          iconJump(num);
        }
        break
